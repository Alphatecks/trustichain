...
const BusinessSuiteDisputeDetail = () => {
      ...
      <main className="dashboard-main">
        ...
        <div className="dispute-detail-content">
          ...
          <div className="card-breadcrumb">
            ...
            <span className="breadcrumb-link" onClick={() => navigate('/business-dispute')}>Dispute</span>
            <span className="breadcrumb-divider">›</span>
...
export default BusinessSuiteDisputeDetail;
