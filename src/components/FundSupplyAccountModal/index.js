    ...
    <div className="create-escrow-modal-overlay" onClick={handleCloseModal}>
      <div className="create-escrow-modal" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '500px' }}>
        ...
        <div className="create-escrow-modal-content" style={{ padding: '2rem' }}>
          ...
          <div className="fund-supply-section">
            <div className="fund-supply-header">
              <label className="fund-supply-label">Amount</label>
              <div className="wallet-selector-wrapper">
                ...
                >
                  <img 
                    ...
                    onError={(e) => {
                      // Fallback to circle with text if image fails to load
                  ...
                  />
                  <div className="wallet-selector-icon-fallback" style={{ display: 'none' }}>
                    <span className="wallet-selector-icon-text">XRP</span>
                  </div>
            ...
            <div className="fund-supply-amount-display">
            ...
            <button 
              type="button"
              className="fund-supply-transfer-btn"
              onClick={handleTransfer}
            >
              Transfer
            </button>

            <div className="fund-supply-info">
              <Info size={16} />
...
export default FundSupplyAccountModal;
